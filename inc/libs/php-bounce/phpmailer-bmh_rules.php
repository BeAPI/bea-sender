...
function bmhBodyRules($body,$structure,$debug_mode=false) {
   ...
   */
  if (preg_match ("*no such address here*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0237';
    $result['email']       = $match[1];
  }
  
  elseif (preg_match ("*Domain name not found*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0237';
    $result['email']       = $match[1];
  }
   ...
   *     #                                                        #
   */
  elseif (preg_match ("*Can't create output.*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0169';
    $result['email']       = $match[1];
  }
   ...
   * xxxxx@yourdomain.com : ????, ?????.
   */
  elseif (preg_match ("*=D5=CA=BA=C5=B2=BB=B4=E6=D4=DA*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0174';
    $result['email']       = $match[1];
  }
   ...
   * Unrouteable address
   */
  elseif (preg_match ("*Unrouteable address*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0179';
    $result['email']       = $match[1];
  }
   ...
   */
  elseif (preg_match ("*unknown local-part*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0232';
    $result['email']       = $match[1];
  }
   ...
   */
  elseif (preg_match ("*user is inactive*",$body,$match)) {
   ...
   */
  elseif (preg_match ("*inactive account*",$body,$match)) {
    $result['rule_cat']    = 'inactive';
    $result['rule_no']     = '0181';
    $result['email']       = $match[1];
  }
   ...
   */
  elseif (preg_match ("*can not open new email file*",$body,$match)) {
    $result['rule_cat']    = 'internal_error';
    $result['rule_no']     = '0173';
    $result['bounce_type'] = 'hard';
    $result['remove']      = 1;
   ...
   */
  elseif (preg_match ("*Resources temporarily unavailable*",$body,$match)) {
   ...
   */
  elseif (preg_match ("*AutoReply message from *",$body,$match)) {
   ...
   */
  elseif (preg_match ("*non-Western*",$body,$match)) {
   ...
   */
  if (preg_match ("*Recipient address rejected*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0046';
    $result['email']       = $match[1];
  }
   ...
   */
  if (preg_match ("*in reply to end of DATA command*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0047';
    $result['email']       = $match[1];
  }
   ...
   */
  if (preg_match ("*in reply to RCPT TO command*",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0048';
    $result['email']       = $match[1];
  }
