...
class Bea_Sender_Sender {
	...
	private function getCampaigns() {
		...
		$cols = $wpdb->get_col( $wpdb->prepare( "SELECT id FROM $wpdb->bea_s_campaigns WHERE current_status IN( '".implode( "','", Bea_Sender_Campaign::getAuthStatuses() )."' ) AND scheduled_from <= NOW() ORDER BY add_date ASC" ) );
