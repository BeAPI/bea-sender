<?php
class Bea_Sender_Email {

	public static function wpMail( $to, $subject, $message = array(), $headers = '', $attachments = array() ) {
		 ...
		 * there's no easy alternative. Defaulting to admin_email might appear to be
		 * another
		...
		if( isset( $message['html'] ) )
			...
			$phpmailer->Body = 'No content for the email, contact the administrator !';
		if( isset( $message['raw'] ) )
			$phpmailer->AltBody = $message['raw'];
