...
?>
<div class="wrap"> 
	<h2><?php echo get_admin_page_title(); ?><a class="add-new-h2" href="<?php echo add_query_arg( array( 'page' => 'bea_sender' ), admin_url( '/tools.php' ) ); ?>"> <?php _e( 'Return to campaigns', 'bea_sender') ?></a></h2>
