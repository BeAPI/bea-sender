...
<div class="wrap">
	...
	<a href="<?php echo wp_nonce_url( add_query_arg( array( 'page' => 'bea_sender', 'bea_s-export' => 'true' ), admin_url( '/tools.php' ) ), 'bea-sender-export' ); ?>" class="add-new-h2"><?php _e( 'Export all emails to CSV', 'bea_sender' ) ?></a></h2>
